...
export default function WhatsAppLayout() {
  ...
  const handleTabChange = (tab) => {
      setActiveTab(tab)
      setShowUserProfile(false) // Close profile when switching tabs
                ...
                >
                    ...
                    {showSettings && (
                        <div className='settings-menu'>
                            ...
                            {/* Profile moved to sidebar avatar */}
                            <button className='settings-menu-item' onClick={(e) => e.stopPropagation()}>
                                Cerrar sesión
                            </button>
                        </div>
                ...
                <div 
                    ...
                    onClick={() => {
                        if (showUserProfile) {
                            ...
                            setActiveTab('chats') // Return to chats
                        } else {
                            setShowUserProfile(true)
                            setActiveTab('') // Deselect other tabs visually
                            setShowSettings(false)
                        }
                    }}
                    title="Mi Perfil"
